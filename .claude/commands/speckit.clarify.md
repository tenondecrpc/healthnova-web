...
**Input**: The argument after `/speckit.clarify` is whatever the user wants to think about (a feature name matching `specs/<NNN>-name/` or a free-form idea).
...
- Mark ambiguous requirements with `[NEEDS CLARIFICATION: <question>]`
...
If the user mentions a specific feature, read its artifacts for context (`specs/<NNN>-name/`).

When insights crystallize, offer to capture them:

| Insight Type             | Where to Capture               |
| ------------------------ | ------------------------------ |
| Research finding         | `specs/<NNN>-name/research.md` |
| Requirement or decision  | `specs/<NNN>-name/spec.md`     |
| Scope or approach change | `specs/<NNN>-name/plan.md`     |
...
- **Do read `.specify/memory/constitution.md`** — Know the project constraints
